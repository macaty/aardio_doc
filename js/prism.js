...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (Prism.languages.markup) {
        Prism.languages.markup.tag.addInlined('script', 'aardio');
    }
    ...
    var linkText = document.getElementById('aardio-document-home');

    function updateLinkState(isAIMode, selectedText) {
        if (isAIMode) {
            linkText.innerText = "问 AI";
            backToHomeLink.title = "对选中内容有疑问？点这里问 AI";
            homeIcon.style.display = 'none';
            aiIcon.style.display = 'inline-block';
            backToHomeLink.href = "../../ai/prompt/-q="/*tpa=https://www.aardio.com/zh-cn/ai/prompt/?q=*/ + encodeURIComponent(selectedText);
            backToHomeLink.style.display =  'inline-block' ;
            backToHomeLink.target = "_self";  
        } else {
            linkText.innerText = "aardio 文档";
            backToHomeLink.title = "aardio 编程语言文档首页";
            homeIcon.style.display = 'inline-block';
            aiIcon.style.display = 'none';
            backToHomeLink.href = "../index.htm"/*tpa=https://www.aardio.com/zh-cn/doc/*/;
            backToHomeLink.target = "_self";  
            backToHomeLink.style.display = (window.self === window.top) ? 'inline-block' : 'none';
        }
    }
    ...
    document.onmouseup = document.onkeyup = document.onselectionchange = function() {
        ...
        if (selectedText) {
            updateLinkState(true, selectedText);
