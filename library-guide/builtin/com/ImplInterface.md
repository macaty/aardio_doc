...
3. 函数示例�?
   ...
   �?IDispatch 接口对象中可使用 [\_call 元方法](https://www.aardio.com/zh-cn/doc/language-reference/datatype/table/meta.html#_call) 定义 COM 默认调用，使�?[\_item 元方法](https://www.aardio.com/zh-cn/doc/language-reference/datatype/table/meta.html#_item) 定义 COM 枚举表或 COM 默认调用表�?
