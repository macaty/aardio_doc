...
2. 函数说明�?
   ...
   使用模糊匹配比较类名、标题，支持 [模式语法](https://www.aardio.com/zh-cn/doc/library-guide/builtin/string/patterns.html) �?
   可选指定一个以毫秒为单位的超时值�?
...
2. 函数说明�?
   ...
   winex.find使用模糊匹配来查找类名、标题，支持 [模式语法](https://www.aardio.com/zh-cn/doc/library-guide/builtin/string/patterns.html) �?
...
2. 函数说明�?
   ...
   winex.findEx使用模糊匹配来查找类名、标题，支持 [模式查找语法](https://www.aardio.com/zh-cn/doc/library-guide/builtin/string/patterns.html) �?
...
2. 函数说明�?
   ...
   winex.findExists同样支持使用模糊匹配来查找类名、标题，支持 [模式查找语法](https://www.aardio.com/zh-cn/doc/library-guide/builtin/string/patterns.html) �?
   这个函数是非常有用的一个函�?
...
2. 函数说明�?
   ...
   winex.wait同样支持使用模糊匹配来查找类名、标题，支持 [模式查找语法](https://www.aardio.com/zh-cn/doc/library-guide/builtin/string/patterns.html) �?
...
2. 函数说明�?
   在指定的父窗口枚举所有子窗口、除回调函数以外，所有参数为可选参数。类名与标题支持 [模式语法](https://www.aardio.com/zh-cn/doc/library-guide/builtin/string/patterns.html) �?
...
2. 函数说明�?
   父窗口句柄为可选参数，默认为桌面窗口。类名和标题都支�?[模式查找语法](https://www.aardio.com/zh-cn/doc/library-guide/builtin/string/patterns.html) �?
...
2. 函数说明�?
   ...
   菜单标题支持 [模式查找语法](https://www.aardio.com/zh-cn/doc/library-guide/builtin/string/patterns.html) ，菜单序号自1开�?第一个子菜单序号�?�?
3. 调用示例�?
