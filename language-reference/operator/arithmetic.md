...
如果参考算术运算的操作数是数值、字符串以外的其他数据类型则查找该对象的元方法进行运算，如果对象并未定义元方法则抛出异常�?请参考： [重载操作符](overloading.html) [元方法](https://www.aardio.com/zh-cn/doc/language-reference/datatype/table/meta.html)
